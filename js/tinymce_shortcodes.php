		...
		function returnShortcodeValue() {
			...
			case "button_download":
				...
				case "searchbox":
					...
					out = "[searchbox]Search[/searchbox]<br />";

					break;	

				case "progressbar":

					out = "[progressbar progress=30 color=#F15A23]Title[/progressbar]<br />";
				...
				case "list_comment":
					...
					out = "[list_comment]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_comment]";

					break;

				case "list_circle":

					out = "[list_circle]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_circle]";

					break;

				case "list_plus":

					out = "[list_plus]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_plus]";

					break;

				case "list_ribbon":

					out = "[list_ribbon]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_ribbon]";

					break;

				case "list_settings":

					out = "[list_settings]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_settings]";

					break;

				case "list_star":

					out = "[list_star]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_star]";

					break;

				case "list_image":

					out = "[list_image]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_image]";

					break;

				case "list_link":

					out = "[list_link]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_link]";

					break;		

				case "list_mail":

					out = "[list_mail]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_mail]";

					break;						

				case "list_arrow":

					out = "[list_arrow]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_arrow]";

					break;

				case "list_tick":

					out = "[list_tick]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_tick]";

					break;					

				case "list_arrow_point":

					out = "[list_arrow_point]<li>list item...</li><li>list item...</li><li>list item...</li><li>list item...</li>[/list_arrow_point]";

					break;	

				case "blockquote_left":

					out = "[blockquote align=\"left\"]Lorem ipsum dolor sit amet....[/blockquote]";
...
<body>
	...
	<div>
        ...
        <select id="select_shortcode">
			...
			<optgroup label="Toggle & Boxes Elements">				
