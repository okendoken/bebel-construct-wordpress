...
<div class="grid_15 omega">
  <div class="widget">
    <input class="widefat" style="max-width: 250px" id="upload_big_post_image<?php echo $key ?>" type="button" value="<?php echo isset($widget['options']['button_text']) ? $widget['options']['button_text'] : 'Upload' ?>" />
