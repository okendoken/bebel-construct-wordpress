<div class="wrap">
  ...
  <h2><?php _e('New Theme Update for ', $this->settings->getPrefix()); echo $this->settings->getThemename() ?></h2>
  ...
  <p><?php _e('Please update as soon as possible - it might fix some security issues! We provide a changelog for this version, <a href="update.thebebel.com/'.strtolower($this->settings->getThemename()).'-changelog-'.$this->update_status->currentVersion.'.txt" target="_blank">check it out here</a>', $this->settings->getPrefix()) ?></p>
