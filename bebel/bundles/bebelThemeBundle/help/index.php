...
<h3 class="center alt">&ldquo;People&rdquo; Documentation by &ldquo;Bebel&rdquo; for Theme v1.0</h3>
		

		

		<h1 class="center">&ldquo;People&rdquo;</h1>

		<div class="borderTop">
			<div class="span-6 colborder info prepend-1">
				<p class="prepend-top">
					<strong>
					Created: 09/04/2012<br>
					Updated: ---<br>
					By: Bebel<br>
		...
		<p>
        	People is a lightweight premium theme that will help your company get more attention without doing too much work.
        </p>
        ...
        <p>
        	Lets get started! First of all, go to the theme's configuration panel. After the theme activation, you will notice there is a new point called "People" beneith "Appearance" (Where you just activated the theme). <br />
            This is where all of the themes settings come together and are managed. You'll notice 5 points.
        </p>

        <ol>
			<li>Theme Configuration</li>
			<li>Installation / Reset</li>
			<li>Help &amp; Support</li>
		</ol>
        ...
        <h4 id="sidebar-generator"><strong>2) Installation / Reset</strong> - <a href="#toc">top</a></h4>

        <p>This is where you can find the one click installation, in case you skipped it while installing the theme. </p>

        
        <h4 id="help-support"><strong>4) Help &amp; Support</strong> - <a href="#toc">top</a></h4>

        <p>The fourth point, <em>Help &amp; Support</em> contains this help file. You don't have to worry if you log on from another computer. You can always read this documentation in your WordPress backend.</p>
        ...
        <p>When activating the theme, or by clicking on "Installation / Reset" found in the theme menu, you can install the theme automatically. Now, this does not set up the page like the demo. 
            We can not do this because of the image licensing and copyright of the images we provide on the demo. So we set up a easy to start with xml file, which will be automatically inserted into your installation.</p>
        ...
        <p>We use the default way of wordpress to set up the menu. Please read this tutorial of the wordpress documentation: <a href="http://codex.wordpress.org/WordPress_Menu_User_Guide" target="_blank">http://codex.wordpress.org/WordPress_Menu_User_Guide</a></p>
        ...
        <p>This part is video only. It will teach you all the important things about the post options. Please watch it, as it contains several important information!</p>
        ...
        <p>
            Follow these steps to activate and use Mailchimp with People Event Theme
        </p>
        <ol>
            <li>Go to your WordPress backend and to the „Theme Configuration“ within the People menu.</li>
            ...
            <li>Go to your WordPress backend and to the „Theme Configuration“ within the People menu. Notice the new Mailchimp tab on top – click on it!</li>
		...
		<h3 id="your-code"><strong>J) Extending and Modifying the Theme</strong> - <a href="#toc">top</a></h3>
		...
		<p>Thanks to the following projects for making People possible<br />
