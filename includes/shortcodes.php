...
return '<ul class="arrowul">' .$content. '</ul>';
...
function shortcode_searchbox($atts, $content = null) {


return '<form method="get" action="'.home_url().'">
            <input type="text" value="" name="s" class="greeninput" placeholder="Search">
            <input type="submit" value="Search" class="grennicon">
        	</form><br>';

}

add_shortcode('searchbox', 'shortcode_searchbox');
